...
def get_features_targets_from_data(data_dict, end=100, 
    ...
    values below 100 cycles, as well as knee and knee-onset point
    values that were estimated to be below the 100 cycle. These
    cells are considered defective.
    """
    from collections import defaultdict
    from scipy.integrate import simpson
    ...
    for cell in data_dict.keys():
        ...
        if targets == 'knee' or targets == 'knee-onset':
            ...
            # Check the estimated knee point.
            if targets == 'knee':
                if knee_point < 0:
            ...
            # Check the estimated knee-onset point.
